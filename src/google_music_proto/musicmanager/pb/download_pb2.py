...
_GETTRACKSTOEXPORTREQUEST_TRACKSTOEXPORTTYPE = _descriptor.EnumDescriptor(
	...
	values=[
		_descriptor.EnumValueDescriptor(
			name='ALL', index=0, number=1, options=None, type=None
		),
		_descriptor.EnumValueDescriptor(
			name='PURCHASED_AND_PROMOTIONAL', index=1, number=2, options=None, type=None
		),
	],
...
_GETTRACKSTOEXPORTRESPONSE_TRACKSTOEXPORTSTATUS = _descriptor.EnumDescriptor(
	...
	values=[
		...
		_descriptor.EnumValueDescriptor(
			name='TRANSIENT_ERROR', index=1, number=2, options=None, type=None
		),
		_descriptor.EnumValueDescriptor(
			name='MAX_NUM_CLIENTS_REACHED', index=2, number=3, options=None, type=None
		),
		_descriptor.EnumValueDescriptor(
		...
		_descriptor.EnumValueDescriptor(
			name='UNABLE_TO_REGISTER_CLIENT', index=4, number=5, options=None, type=None
		),
	],
	containing_type=None,
	options=None,
...
_GETTRACKSTOEXPORTREQUEST = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			name='client_id',
			full_name='wireless_android_skyjam.GetTracksToExportRequest.client_id',
			index=0,
			number=2,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='wireless_android_skyjam.GetTracksToExportRequest.continuation_token',
			index=1,
			number=3,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			name='export_type',
			full_name='wireless_android_skyjam.GetTracksToExportRequest.export_type',
			index=2,
			number=4,
			type=14,
			cpp_type=8,
		...
		_descriptor.FieldDescriptor(
			name='updated_min',
			full_name='wireless_android_skyjam.GetTracksToExportRequest.updated_min',
			index=3,
			number=5,
			type=3,
			cpp_type=2,
	...
	extensions=[],
	nested_types=[],
	enum_types=[_GETTRACKSTOEXPORTREQUEST_TRACKSTOEXPORTTYPE],
	options=None,
	is_extendable=False,
	syntax='proto2',
	extension_ranges=[],
...
_DOWNLOADTRACKINFO = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			name='id',
			full_name='wireless_android_skyjam.DownloadTrackInfo.id',
			index=0,
			number=1,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			name='title',
			full_name='wireless_android_skyjam.DownloadTrackInfo.title',
			index=1,
			number=2,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			name='album',
			full_name='wireless_android_skyjam.DownloadTrackInfo.album',
			index=2,
			number=3,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			name='album_artist',
			full_name='wireless_android_skyjam.DownloadTrackInfo.album_artist',
			index=3,
			number=4,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			name='artist',
			full_name='wireless_android_skyjam.DownloadTrackInfo.artist',
			index=4,
			number=5,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			name='track_number',
			full_name='wireless_android_skyjam.DownloadTrackInfo.track_number',
			index=5,
			number=6,
			type=5,
			cpp_type=1,
		...
		_descriptor.FieldDescriptor(
			name='track_size',
			full_name='wireless_android_skyjam.DownloadTrackInfo.track_size',
			index=6,
			number=7,
			type=3,
			cpp_type=2,
		...
		_descriptor.FieldDescriptor(
			name='disc_number',
			full_name='wireless_android_skyjam.DownloadTrackInfo.disc_number',
			index=7,
			number=8,
			type=5,
			cpp_type=1,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='wireless_android_skyjam.DownloadTrackInfo.total_disc_count',
			index=8,
			number=9,
			type=5,
			cpp_type=1,
...
_GETTRACKSTOEXPORTRESPONSE = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			name='status',
			full_name='wireless_android_skyjam.GetTracksToExportResponse.status',
			index=0,
			number=1,
			type=14,
			cpp_type=8,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='wireless_android_skyjam.GetTracksToExportResponse.download_track_info',
			index=1,
			number=2,
			type=11,
			cpp_type=10,
		...
		_descriptor.FieldDescriptor(
			name='continuation_token',
			full_name='wireless_android_skyjam.GetTracksToExportResponse.continuation_token',
			index=2,
			number=3,
			type=9,
			cpp_type=9,
		...
		_descriptor.FieldDescriptor(
			name='updated_min',
			full_name='wireless_android_skyjam.GetTracksToExportResponse.updated_min',
			index=3,
			number=4,
			type=3,
			cpp_type=2,
	...
	extensions=[],
	nested_types=[],
	enum_types=[_GETTRACKSTOEXPORTRESPONSE_TRACKSTOEXPORTSTATUS],
	options=None,
	is_extendable=False,
	syntax='proto2',
	extension_ranges=[],
...
_GETTRACKSTOEXPORTREQUEST.fields_by_name[
	'export_type'
].enum_type = _GETTRACKSTOEXPORTREQUEST_TRACKSTOEXPORTTYPE
_GETTRACKSTOEXPORTREQUEST_TRACKSTOEXPORTTYPE.containing_type = _GETTRACKSTOEXPORTREQUEST
_GETTRACKSTOEXPORTRESPONSE.fields_by_name[
	'status'
].enum_type = _GETTRACKSTOEXPORTRESPONSE_TRACKSTOEXPORTSTATUS
_GETTRACKSTOEXPORTRESPONSE.fields_by_name[
	'download_track_info'
].message_type = _DOWNLOADTRACKINFO
_GETTRACKSTOEXPORTRESPONSE_TRACKSTOEXPORTSTATUS.containing_type = (
	_GETTRACKSTOEXPORTRESPONSE
)
...
GetTracksToExportRequest = _reflection.GeneratedProtocolMessageType(
...
DownloadTrackInfo = _reflection.GeneratedProtocolMessageType(
	'DownloadTrackInfo',
	(_message.Message,),
	dict(
...
GetTracksToExportResponse = _reflection.GeneratedProtocolMessageType(
	'GetTracksToExportResponse',
	(_message.Message,),
	dict(
